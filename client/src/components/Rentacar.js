    ...
    return (
        <>
            ...
            <header className="header">
                ...
                <input type="text" name="name"  placeholder="Search Car" style={{ width: "30%", height: "8%"}}value={searchText} onChange={(e)=>setSearchText(e.target.value)} className='search'/>
            ...
            <div className="buycarcard">
                ...
                {rentCarsData.map((rentCarsData, index) => 
                        ...
                        <div className ="specsDivRentcar" key={new Date}>
                            ...
                            <p style={{color: "white"}}>Availibility : {rentCarsData.availability +" hours"}</p>
                            
                            <div style={{display: "flex", gap: "15px"}}>
                            <button className='specsbtn' ><NavLink className="nav-link" to={{pathname: '/rentcarreviews', state:{id: rentCarsData._id}}} >Car Reviews</NavLink></button>
                            <button className='specsbtn' id = {index} onClick={showCar}>show car</button>
                            </div>
                        </div>,
                        ...
                        <div className = "formDivRentcar"  key={index}>
                            ...
                            <input style={{}} type="text"  className='renthour' name="rentforhours" value={rentHours} onChange={handleInputs} placeholder="Enter rent hours" /><br/><br/>
