            ...
            <div style={{
                ...
                {items.map((items) => 
                    <div className = "salecartLidiv"  key={items._id}>
                            <ul>
                                <li style={{wordSpacing: "10px"}}>Brand: {items.brand} --- Model: {items.model} --- Hours: {items.requiredhours} --- RentPerHour: {items.rentperhour}Rs --- TotalBill: {items.totalbill}Rs   <button style={{background:"red"}} className="btn"><i  className="fa fa-trash"></i></button></li>
                            </ul> 
                        </div>
