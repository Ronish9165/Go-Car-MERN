        ...
        <>
            ...
            <header className="header">
                ...
                <nav className="navbar">
                    ...
                    <input type="text" name="name" value={searchText} onChange={(e)=>setSearchText(e.target.value)} placeholder="Search Car" style={{ width: "30%", height: "8%"}} className="search"/>
            ...
            <div className="buycarcard">
                ...
                {saleCarsData.map((saleCarsData, index) => 
                        ...
                        <div className ="specsDivBuycar" key={index}>
                            ...
                            <div className='griddiv'>
                            <button  className='specsbtn'><NavLink  to={{pathname: '/carreviews', state:{id: saleCarsData._id}}} >Car Reviews</NavLink></button>
