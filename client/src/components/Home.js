...
const Home = () => {
    ...
    const Loginbutton= () =>{
        ...
        if(state){
            ...
            return <div>  
                    <button ><NavLink className="btn service-btn" to="/signin">login</NavLink></button>
...
<NavLink className="btn" to="/buycar">Explore-Sale-Cars</NavLink>{" "}
<NavLink className="btn" to="/rentcar">Explore-Rent-Cars</NavLink>
...
<div className="box-container">
    ...
    <div className="box">
        ...
        <button  className="btn service-btn"><NavLink to="/buycar">Check Cars</NavLink></button>
    </div>
    ...
    <div className="box">
        ...
        <h3>Rent A Car</h3>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Corporis, nisi.</p>
        <button className="btn service-btn"><NavLink to="/rentcar">Check Cars</NavLink></button>
    </div>
    ...
    <i className="fas fa-car"></i>
        ...
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Corporis, nisi.</p>
        <button className="btn service-btn"><NavLink to="/saleyourcar">Check Cars</NavLink></button>
    </div>
...
<div className="box-container">
    ...
    <div className="box">
        ...
        <a href="#"> <i className="fas fa-envelope"></i> gocar@gmail.com </a>
        <a href="#"> <i className="fas fa-map-marker-alt"></i> softwarica College, Dillibazar </a>
    </div>
...
<div className="credit"> GoCar | all rights reserved </div>
